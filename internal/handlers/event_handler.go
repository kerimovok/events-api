...
// - filters: Optional JSON string for complex MongoDB queries (e.g., {"status":"active","created_at":{"$gte":"2024-01-01"}})
...
// - filters: Optional JSON string for complex MongoDB queries
